...
import { assertPasskeyError, PasskeyErrorCode } from './errors/passkeyError.mjs';
import { handlePasskeyRegistrationError } from './errors/handlePasskeyRegistrationError.mjs';
