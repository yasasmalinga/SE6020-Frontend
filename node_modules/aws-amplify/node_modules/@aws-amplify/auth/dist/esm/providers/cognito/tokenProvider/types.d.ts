import { AuthConfig, AuthTokens, ClientMetadataProvider, FetchAuthSessionOptions, KeyValueStorageInterface, TokenProvider } from '@aws-amplify/core';
import { ClientMetadata, CognitoAuthSignInDetails } from '../types';
export type TokenRefresher = ({ tokens, authConfig, username, clientMetadata, }: {
