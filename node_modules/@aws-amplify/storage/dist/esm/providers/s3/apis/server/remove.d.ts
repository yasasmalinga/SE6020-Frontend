...
import { RemoveInput, RemoveOperation, RemoveOutput, RemoveWithPathInput, RemoveWithPathOutput } from '../../types';
/**
 ...
 */
export declare function remove(contextSpec: AmplifyServer.ContextSpec, input: RemoveWithPathInput): RemoveOperation<RemoveWithPathOutput>;
/**
 ...
 */
export declare function remove(contextSpec: AmplifyServer.ContextSpec, input: RemoveInput): RemoveOperation<RemoveOutput>;
