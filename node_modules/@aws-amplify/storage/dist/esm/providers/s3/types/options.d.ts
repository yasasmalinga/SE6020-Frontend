 ...
 * @internal
 */
export type AWSTemporaryCredentials = Required<Pick<AWSCredentials, 'accessKeyId' | 'secretAccessKey' | 'sessionToken' | 'expiration'>>;
/**
 ...
 * @internal
 */
export type LocationCredentialsProvider = (options?: CredentialsProviderOptions) => Promise<{
