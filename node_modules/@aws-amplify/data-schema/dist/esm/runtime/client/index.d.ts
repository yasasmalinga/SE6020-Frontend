...
type RestoreArrays<Result, FlatModel> = {
    [K in keyof NonNullable<Result>]: K extends keyof NonNullable<FlatModel> ? Array<any> extends NonNullable<FlatModel>[K] ? HandleArrayNullability<NonNullable<Result>[K], NonNullable<FlatModel>[K]> : NonNullable<FlatModel>[K] extends Record<string, any> ? RestoreArrays<NonNullable<Result>[K], NonNullable<FlatModel>[K]> : NonNullable<Result>[K] : never;
};
/**
 ...
 */
type HandleArrayNullability<Result, FlatModel> = Array<any> extends Result ? Result : NonNullable<FlatModel> extends Array<infer InnerValue> ? null extends FlatModel ? null extends InnerValue ? // value and array are nullable - a.ref('SomeType').array()
Array<RestoreArrays<Result, UnwrapArray<FlatModel>> | null> | null : // value required; array nullable - a.ref('SomeType').required().array()
Array<RestoreArrays<Result, UnwrapArray<FlatModel>>> | null : null extends InnerValue ? Array<RestoreArrays<Result, UnwrapArray<FlatModel>> | null> : Array<RestoreArrays<Result, UnwrapArray<FlatModel>>> : never;
/**
...
type DeepPickFromPath<FlatModel extends Model, Path extends string> = FlatModel extends undefined ? DeepPickFromPath<NonNullable<FlatModel>, Path> | undefined : FlatModel extends null ? DeepPickFromPath<NonNullable<FlatModel>, Path> | null : FlatModel extends any[] ? DeepPickFromPath<UnwrapArray<FlatModel>, Path> : Path extends `${infer Head}.${infer Tail}` ? Head extends keyof FlatModel ? Tail extends '*' ? {
    [k in Head]: FlatModel[Head] extends Record<string, unknown> ? NonRelationshipFields<FlattenArrays<FlatModel[Head]>> : NonRelationshipFields<UnwrapArray<FlatModel[Head]>>;
} : {
