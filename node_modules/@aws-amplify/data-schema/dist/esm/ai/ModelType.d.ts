...
declare const supportedModelsLookup: {
    readonly 'Amazon Nova Pro': "amazon.nova-pro-v1:0";
    readonly 'Amazon Nova Lite': "amazon.nova-lite-v1:0";
    readonly 'Amazon Nova Micro': "amazon.nova-micro-v1:0";
    ...
    readonly 'Claude 3.7 Sonnet': "anthropic.claude-3-7-sonnet-20250219-v1:0";
    readonly 'Claude Opus 4': "anthropic.claude-opus-4-20250514-v1:0";
    readonly 'Claude Sonnet 4': "anthropic.claude-sonnet-4-20250514-v1:0";
    readonly 'Claude Haiku 4.5': "global.anthropic.claude-haiku-4-5-20251001-v1:0";
    readonly 'Claude Sonnet 4.5': "global.anthropic.claude-sonnet-4-5-20250929-v1:0";
    readonly 'Claude Opus 4.5': "global.anthropic.claude-opus-4-5-20251101-v1:0";
